...
namespace WebApplication1.Controllers
{
    ...
    public class EjecucionReporte : ControllerBase
    {
        ...
        //[HttpGet]
        //public IActionResult BajarExtraccionExcelFTP(string nombre)
        //{
        ...
        //            // Descargar el archivo asincrónicamente
        //            byte[] fileBytes = await webClient.DownloadDataTaskAsync($"ftp://{ftpServerIP}{remoteFilePath}");

        //            // Devolver el archivo directamente al cliente
        //            return File(fileBytes, "application/zip", nombre);
        //        }
        //    }
        //    catch (Exception ex)
        ...
        //        return StatusCode(500, $"Error al descargar el archivo del servidor FTP: {ex.Message}");
        //    }
        //}

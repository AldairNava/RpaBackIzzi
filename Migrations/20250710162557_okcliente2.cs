...
{
    /// <inheritdoc />
    public partial class okcliente2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    encuesta = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    osGenerada = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_okCliente2", x => x.Id);
                });
        }

    ...
    public partial class version116 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepuracionExportSiebel", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "DepuracionFallas",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Semaforo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Vencimiento = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumeroFG = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Rama = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Nodo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FiberDeep = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FechaInicio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Inicidente = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FechaCarga = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepuracionFallas", x => x.Id);
                });
        }

...
{
    /// <inheritdoc />
    public partial class version1268 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "NotDoneCreacionOrdenModel",
                columns: table => new
                {
                    ...
                    statusNegocioGenerado = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    numeroAjuste = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    estatusAjuste = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotDoneCreacionOrdenModel", x => x.Id);
                });
        }
